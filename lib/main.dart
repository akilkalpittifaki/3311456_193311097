...
import 'package:quiz3/soruhavuzu.dart';

//import 'package:quiz/soru.dart';

//import 'soru.dart';
import 'package:rflutter_alert/rflutter_alert.dart'; //bu kütüphaneyi bitiş widgeti için, en sondaki ekran için indirdik. pub.dev den
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        //Image.asset("assets/images/filo.jpg")
      ],
    );
  }
}
